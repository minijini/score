...
public class P4Activity extends Activity {
    Button id1,id2,id3,id4; //점수 카운트
    Button btn1,btn2,btn3,btn4; //닉네임 변경
    Button plus1,plus2,plus3,plus4; //+
    Button minus1,minus2,minus3,minus4; //-
    EditText edit1,edit2,edit3,edit4;  //닉네임
    TextView txt1,txt2,txt3,txt4; // 닉네임
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences score = getSharedPreferences("score4",MODE_PRIVATE);
        ...
        Button.OnClickListener onClickListener1 = new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                sharedPreferences = getSharedPreferences("name4",MODE_PRIVATE);
...
//                        }
        ...
        Button.OnClickListener onClickListener2 = new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                sharedPreferences = getSharedPreferences("score4",MODE_PRIVATE);
                editor = sharedPreferences.edit();
    ...
    public void nameshared(){
        SharedPreferences sf = getSharedPreferences("name4",MODE_PRIVATE);
    ...
    public void reset(){
        ...
        SharedPreferences scorerm = getSharedPreferences("score4", Activity.MODE_PRIVATE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.random:
               Intent intent = new Intent(this, Random4Activity.class);
    ...
    public void dialog(){
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(P4Activity.this);
        // 제목셋팅
