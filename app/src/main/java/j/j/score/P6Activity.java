...
public class P6Activity extends Activity {
    ...
    Button btn1,btn2,btn3,btn4,btn5,btn6; //닉네임 변경
    Button plus1,plus2,plus3,plus4,plus5,plus6; //+
    Button minus1,minus2,minus3,minus4,minus5,minus6; //-
    EditText edit1,edit2,edit3,edit4,edit5,edit6;  //닉네임
    TextView txt1,txt2,txt3,txt4,txt5,txt6; // 닉네임
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nameshared();
        SharedPreferences score = getSharedPreferences("score6",MODE_PRIVATE);
        ...
        if(score != null) {
            ...
            String s6 = score.getString("score6", "0");
        ...
        Button.OnClickListener onClickListener1 = new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                sharedPreferences = getSharedPreferences("name6",MODE_PRIVATE);
...
//                        }
                    ...
                    case R.id.btn6 :
                        if (btn6.getText().toString().equals("변경") && !edit6.getText().toString().equals("")) {
                            txt6.setVisibility(View.VISIBLE);
                            edit6.setVisibility(View.INVISIBLE);

                            String text6 = edit6.getText().toString();
                            editor.putString("edit6",text6);
                            editor.commit();

                            dialog();

                        } else if (btn6.getText().toString().equals("변경")&&edit6.getText().toString().equals("")) {
        ...
        Button.OnClickListener onClickListener2 = new Button.OnClickListener() {
            @Override
            public void onClick(View view) {
                sharedPreferences = getSharedPreferences("score6",MODE_PRIVATE);
                editor = sharedPreferences.edit();
                ...
                switch (view.getId()) {
                    ...
                    case R.id.plus6 :
                        score6 +=1;
                        id6.setText(Integer.toString(score6));

                        String text6 = Integer.toString(score6);
                        editor.putString("score6",text6);
                        editor.commit();
                        break ;
                }
            }
        ...
        btn6.setOnClickListener(onClickListener1);
        ...
        plus6.setOnClickListener(onClickListener2);
        ...
        minus6.setOnClickListener(onClickListener3);
    ...
    public void reset(){
        ...
        SharedPreferences scorerm = getSharedPreferences("score6", Activity.MODE_PRIVATE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.random:
                Intent intent = new Intent(this, Random6Activity.class);
    ...
    public void dialog(){
        ...
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(P6Activity.this);
        // 제목셋팅
                ...
                .setPositiveButton("확인",
                        new DialogInterface.OnClickListener() {
                            public void onClick(
                                ...
                                imm.hideSoftInputFromWindow(edit6.getWindowToken(), 0);
